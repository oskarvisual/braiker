...
6. In Settings, open **View calendar**, verify active/future and past pagination, and confirm neither view offers deletion. Set a longer protection window and verify it persists; values below 10/15 must be rejected.

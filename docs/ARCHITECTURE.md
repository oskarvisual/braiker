...
| Settings | `/settings`, `/api/wallets`, `/api/wallets/[walletId]/capital`, `/api/settings/paper-capital`, `/api/settings/synchronization`, `/api/settings/notifications`, `/api/settings/telegram/pairing`, `/api/settings/macro-guard`, `/api/settings/macro-events` | global Paper capital, serialized virtual-wallet budget changes, schedule, persisted alert preferences, macro protection window and immutable event history |

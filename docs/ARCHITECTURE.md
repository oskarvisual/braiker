...
| Operations | `ScheduledTask`, `JobRun`, `SystemEvent`, `ErrorEvent`, `NotificationSettings`, `NotificationAlert`, `AiRuntimeState`, `WorkerRuntimeState`, `MacroCalendarEvent`, `TelegramManagerSession`, `TelegramPairingCode`, `TelegramRuntimeState`, `TelegramManagerMessage`, `ManagerChatSession`, `ManagerChatMessage`, `ManagerActionProposal`, `BotChatSession`, `BotChatMessage` |

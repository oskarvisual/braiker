...
type DashboardData = {
  ...
  bots: Array<{ id: string; name: string; templateId: string; avatarSeed: string; runMode: string; lifeStatus: "ACTIVE" | "DEAD"; currentCapital: string; initialCapital: string; symbols: string[]; assets: { value: string | null; valuedAt: string | null; unpricedSymbols: string[] } }>;
  botAssetAllocation: { totalValue: string | null; valuedAt: string | null; unpricedSymbols: string[]; items: Array<{ symbol: string; value: string; valuedAt: string }> };
};

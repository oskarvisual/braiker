...
- Bot Manager and individual bot chats share a compact one-line composer that grows only as text wraps; its Send button always matches the current composer height.

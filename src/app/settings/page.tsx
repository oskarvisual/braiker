...
export default async function SettingsPage() {
  ...
  const [wallets, paperCapital, task, notificationSettings, telegramSession, botProfiles, macroEvents, macroGuard] = await Promise.all([
    ...
    prisma.macroGuardSettings.findUnique({ where: { scope: "global" } })
  ]);

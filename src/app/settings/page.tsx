...
export default async function SettingsPage() {
  ...
  const [wallets, paperCapital, task, notificationSettings, telegramSession, botProfiles] = await Promise.all([
